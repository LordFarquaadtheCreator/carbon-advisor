...
import { TransitMethod, useTransitStore } from "@/services/transit";
import { Directions } from "../Maps/Directions";
// const MapOne = dynamic(() => import("../Maps/Directions"), {
//   ssr: false,
// });
...
export default function CarbonDashboard() {
  ...
  } = useTransitStore((state) => state);

  return (
    <>
      <button onClick={() => updateTransitDetails()}>TEST</button>
      {/**  */}
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5">
        <CardDataStats title="miles" total={`${distanceMiles ?? "---"}`}>
          {transitMethod === TransitMethod.CAR ? (
            <svg
          ...
          ) : transitMethod === TransitMethod.BIKE ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="fill-primary dark:fill-white"
              width="22"
          ...
          ) : transitMethod === TransitMethod.TRAIN ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="fill-primary dark:fill-white"
              width="22"
          ...
          ) : transitMethod === TransitMethod.WALK ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="fill-primary dark:fill-white"
              width="22"
